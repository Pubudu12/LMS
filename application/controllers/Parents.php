...
class Parents extends CI_Controller
{
    ...
    function subject($param1 = '', $param2 = '')
    {
        ...
        $parent_profile = $this->db->get_where(
            'parent',
            array(
        ...
        $page_data['subjects'] = $this->db->get_where(
            'subject',
            array(
    ...
    function manage_attendance($date = '', $month = '', $year = '', $class_id = '')
    {
        ...
        if ($_POST) {
            ...
            redirect(base_url() . 'index.php?parants/manage_attendance/' . $date . '/' . $month . '/' . $year . '/' . $class_id, 'refresh');
        }
        $page_data['date'] = $date;
    ...
    {
        redirect(base_url() . 'index.php?parents/manage_attendance/' . $this->input->post('date') . '/' .
    ...
    function invoice($student_id = '', $param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'make_payment') {
            ...
            $system_settings = $this->db->get_where(
                'settings',
                array(
                    'type' => 'paypal_email'
                )
            )->row();
            $invoice_details = $this->db->get_where(
                'invoice',
                array(
