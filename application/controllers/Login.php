...
class Login extends CI_Controller
{
    ...
    {
        // echo $this->session->userdata('admin_login'); die;
    ...
    {
        $this->load->view('backend/parent/register');
    }

    public function teacher_register()
    {
        $this->load->view('backend/teacher/register');
    }
    ...
    function validate_login($email = '', $password = '')
    {
        ...
        // Checking login credential for student - student login removed
