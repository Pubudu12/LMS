	...
	<div class="login-container">
		...
		<div class="login-form">
			...
			<div class="login-content">
				...
				<div class="login-bottom-links">Register:
					<A href="<?php echo base_url(); ?>index.php?login/teacher_register" class="link">
						Teacher
					</A>
					<A href="<?php echo base_url(); ?>index.php?login/parent_register" class="link">
						Parent
					</A>
				</div>
