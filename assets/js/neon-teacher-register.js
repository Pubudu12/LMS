...
; (function ($, window, undefined) {
    ...
    $(document).ready(function () {
        neonLogin.$container = $("#teacher-register-form");
            ...
            submitHandler: function (ev) {
                ...
                */
                ...
                setTimeout(function () {
                    ...
                    $.ajax({
                        url: baseurl + 'index.php?register/teacher_register',
                        method: 'POST',
                        dataType: 'json',
                        data: {
                            name: $("input#teacher-name").val(),
                            phone: $("input#teacher-phone").val(),
                            birthday: $("input#teacher-birthday").val(),
                            email: $("input#teacher-email").val(),
                            password: $("input#teacher-password").val(),
                            sex: $("select#teacher-sex").val(),
                            address: $("input#teacher-address").val(),
                        },
                        error: function () {
                        ...
                        success: function (response) {
                            ...
                            if (response.status === "failed") {
                                ...
                                alert("Registered!")
                                location.href = `${baseurl}index.php?login/index`
                            }
                        }
                    });
