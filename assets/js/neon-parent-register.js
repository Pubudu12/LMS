 ...
 */
 ...
 ; (function ($, window, undefined) {
     ...
     $(document).ready(function () {
         neonLogin.$container = $("#parent-register-form");
             ...
             submitHandler: function (ev) {
                 ...
                 */
                 ...
                 setTimeout(function () {
                     ...
                     $.ajax({
                         url: baseurl + 'index.php?register/parent_register',
                         method: 'POST',
                         dataType: 'json',
                         data: {
                             name: $("input#parent-name").val(),
                             phone: $("input#parent-phone").val(),
                             profession: $("input#parent-profession").val(),
                             email: $("input#parent-email").val(),
                             password: $("input#parent-password").val(),
                             address: $("input#parent-address").val(),
                         },
                         error: function () {
